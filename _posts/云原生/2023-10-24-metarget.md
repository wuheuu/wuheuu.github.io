...
#### 查看虚拟机ip
![](2023-10-30-11-20-02.png)
#### 宿主机端口转发
1. 关闭所有虚拟机
2. VMWare Workstation -> 编辑 -> 虚拟机网络编辑器 -> 更改设置 -> NAT设置 -> 添加 -> 确定 -> 应用 -> 确定
   ![](2023-10-30-11-21-51.png)
   ![](2023-10-30-11-22-35.png)
   ![](2023-10-30-11-23-27.png)
#### ubuntu设置apt-get使用socks5代理
同上文设置
#### 配置ssh
...
4. 确认`ssh-server工作正常`:`netstat -tpl （看到ssh表示工作正常）`
   ![](2023-10-30-11-33-59.png)
#### 更改虚拟机上ssh默认端口
为了以防万一，22端口和10122端口均开启。
![](2023-10-30-11-54-01.png)
#### 更改防火墙设置，开启端口
![](2023-10-30-11-54-50.png)
#### windows虚拟机防火墙新建入站规则
防火墙 -> 高级设置 -> 入站规则 -> 新建规则 -> 规则类型(端口) -> 协议和端口(特定本地端口) -> 允许连接
#### 测试连接
![](2023-10-30-11-52-09.png)